/**
 * This function animates three points that move within the canvas while bouncing off the walls.
 * Each point has a position (x, y), a radius, a color, and a velocity (dx, dy).
 * The animate() function updates the points' positions frame-by-frame and reverses velocity when they hit a canvas boundary.
 * The user can start the animation using a button (startBtn), which resets and replays the animation.
 */
function initCanvas() {
    ...
    function level5() {
        ...
        /**
         * updatePositions - Updates each point's position and handles bouncing off walls.
         */
        ...
        function animate() {
            ...
            currentStep++; // Schedule next frame
        ...
        function startAnimation() {
            ...
            // next declare the points with their velocities
            points = [
                {
                    x: canvas.width / 4,
                    y: canvas.height / 2,
